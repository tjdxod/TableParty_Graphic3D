...
public class PXRMetaAvatarPresetNetworking : PXRMetaAvatarEntityBase
{
    [Serializable]
    ...
    private void ChangeAvatarBodyLayer(OvrAvatarEntity entity)
    {
        ...
        var trigger = head.AddComponent<PXRAvatarTrigger>();
        trigger.IsHead = true;

        var chest = entity.GetSkeletonTransform(CAPI.ovrAvatar2JointType.Chest);
        var chestTrigger = chest.gameObject.AddComponent<PXRAvatarTrigger>();
        chestTrigger.IsBody = true;
