...
{
    /// <summary>
    /// Scan paradigm functions. Similar to fold reductions (<seealso cref="EnumerableExtensions" />), but instead of returning a final value it returns a list of all the intermediate values.
    /// </summary>
