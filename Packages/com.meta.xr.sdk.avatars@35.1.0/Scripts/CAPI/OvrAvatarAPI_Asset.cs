...
namespace Oculus.Avatar2
{
    public static partial class CAPI
    {
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        private static unsafe extern ovrAvatar2Result ovrAvatar2Asset_GetImageDataByIndex(
            ovrAvatar2Id resourceId, UInt32 imageIndex, byte* buffer, UInt32 bufferSize);

        internal static unsafe bool OvrAvatar2Asset_GetImageDataByIndex(
            ovrAvatar2Id resourceId, UInt32 imageIndex, ref NativeArray<byte> buffer, UnityEngine.Object? context = null)
        {
            unsafe
            {
                return ovrAvatar2Asset_GetImageDataByIndex(resourceId, imageIndex, buffer.GetPtr(), buffer.GetBufferSize())
                    .EnsureSuccess("ovrAvatar2Asset_GetImageDataByIndex", assetLogScope, context);
            }
        }
        ...
        // Get vertex buffer texcoord1 data
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2VertexBuffer_GetTexCoord1(
            ovrAvatar2VertexBufferId vertexBufferId, /*ovrAvatar2Vector2f[]*/ IntPtr buffer, UInt32 bytes,
            UInt32 stride);

        // Get vertex buffer texcoord2 data
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2VertexBuffer_GetTexCoord2(
            ovrAvatar2VertexBufferId vertexBufferId, /*ovrAvatar2Vector2f[]*/ IntPtr buffer, UInt32 bytes,
            UInt32 stride);
        ...
        public static unsafe bool OvrAvatar2Primitive_GetMaterialExtensionName(
            ovrAvatar2Id id,
        ...
        {
            return ovrAvatar2Primitive_GetMaterialExtensionName(id, extensionIndex, nameBuffer, nameBufferSize)
                .EnsureSuccess("ovrAvatar2Primitive_GetMaterialExtensionName", assetLogScope, context);
        }

        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        internal static extern unsafe ovrAvatar2Result ovrAvatar2Primitive_GetMaterialExtensionName(
            ovrAvatar2Id id,
            UInt32 extensionIndex,
            byte* nameBuffer,
            UInt32* nameBufferSize);
