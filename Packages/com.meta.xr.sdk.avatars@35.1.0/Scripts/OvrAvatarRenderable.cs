...
#pragma warning restore CA2213 // Disposable fields should be disposed
        ...
        internal readonly WeakReference<OvrAvatarEntity> entity = new WeakReference<OvrAvatarEntity>(null);
         ...
         * @see IsRendering
         */
        protected void OnVisibilityChanged(bool isNowRendered)
        {
        ...
        {
            if (entity.TryGetTarget(out var lockedEntity))
            {
                lockedEntity.TeardownRenderable(this);
        ...
        public CAPI.ovrAvatar2Result GetSubMeshCount(out UInt32 subMeshCount)
        {
            return CAPI.ovrAvatar2Primitive_GetSubMeshCount(AppliedPrimitive.assetId, out subMeshCount);
        }

        public CAPI.ovrAvatar2Result GetSubMeshByIndex(UInt32 subMeshIndex, out CAPI.ovrAvatar2PrimitiveSubmesh subMesh)
        {
            return CAPI.ovrAvatar2Primitive_GetSubMeshByIndex(AppliedPrimitive.assetId, subMeshIndex, out subMesh);
        }
