...
{
#if UNITY_EDITOR
    public static class OvrAvatarDebugUtility
    {
        public static void DebugDrawInEditor(this CAPI.ovrAvatar2Transform transformToDraw, float scale)
        {
        ...
        public static void DebugDrawInEditor(this Transform transformToDraw, float scale)
        {
            Handles.color = Color.red;
