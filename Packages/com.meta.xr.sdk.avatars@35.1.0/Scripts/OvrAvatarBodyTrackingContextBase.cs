...
namespace Oculus.Avatar2
{
    ...
    public abstract class OvrAvatarBodyTrackingContextBase : OvrAvatarCallbackContextBase
    {
        ...
        public OvrAvatarTrackingBodyState BodyState => _bodyState;
        ...
        protected static bool GetBodyState(OvrAvatarBodyTrackingContextBase context, OvrAvatarTrackingBodyState bodyState)
        {
            return context.GetBodyState(bodyState);
        }
        ...
        protected static bool GetBodySkeleton(OvrAvatarBodyTrackingContextBase context, ref OvrAvatarTrackingSkeleton skeleton)
        {
            return context.GetBodySkeleton(ref skeleton);
        }
        ...
        protected static bool GetBodyPose(OvrAvatarBodyTrackingContextBase context, ref OvrAvatarTrackingPose pose)
        {
            return context.GetBodyPose(ref pose);
        }
