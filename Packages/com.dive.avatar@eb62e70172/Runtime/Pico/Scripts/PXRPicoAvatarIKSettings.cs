...
{
    public class PXRPicoAvatarIKSettings : MonoBehaviour
    {
        #region IK Struct
        ...
        public struct HeightAutoFitParam
        {
            ...
            {
                var outParam = new AvatarAutoFitController.AvatarAutoFitParam(maxFloatingTime, maxCrouchingTime, crouchingDistance, maxCrouchingDistance);
                return outParam;
            }
        };
        ...
        /// </summary>
        private Action onValidateCallbackEvent = null;
        ...
        public void SetDefault()
        {
            ...
            onValidateCallbackEvent = null;

            isDirty = true;
        }

        public void SetFindXROrigin()
        {
            XRRoot = PXRRig.Current.transform;
            head.target.transform = PXRRig.PlayerController.CenterEye;
            hands.leftTarget.transform = PXRRig.LeftHandAnimationController.transform.GetChild(0);
            hands.rightTarget.transform = PXRRig.RightHandAnimationController.transform.GetChild(0);
            heightAutoFit.cameraOffsetTarget = PXRRig.PlayerController.transform;
        }
        ...
        public static void Copy(PXRPicoAvatarIKSettings from, PXRPicoAvatarIKSettings to)
        {
            ...
            to.onValidateCallbackEvent = from.onValidateCallbackEvent;
            to.isDirty = true;
        }
        ...
        {
            onValidateCallbackEvent = callback;
        }
        ...
        private void OnValidate()
        {
            ...
            onValidateCallbackEvent?.Invoke();
        }
